...
UI = {
    ...
    "nav_proof": {"ru": "Доказательство", "he": "הוכחה", "en": "Proof"},
    "nav_experiment": {"ru": "Эксперимент", "he": "ניסוי", "en": "Experiment"},
    "nav_story": {"ru": "Сторис", "he": "סטורי", "en": "Story"},
    "nav_autopilot": {"ru": "Автопилот", "he": "אוטופיילוט", "en": "Autopilot"},
    ...
    "optional_label": {"ru": "Необязательно", "he": "אופציונלי", "en": "Optional"},
    "tg_only_ready_title": {"ru": "Telegram уже достаточно для старта", "he": "טלגרם לבדו מספיק כדי להתחיל", "en": "Telegram alone is enough to start"},
    "tg_only_ready_desc": {"ru": "Для пилота подключите только Telegram — этого хватит, чтобы запустить кампанию и получать лиды. Facebook можно добавить позже.", "he": "לפיילוט חבר רק טלגרם — זה מספיק כדי להפעיל קמפיין ולקבל לידים. אפשר להוסיף פייסבוק מאוחר יותר.", "en": "For the pilot, connect Telegram only — that's enough to launch a campaign and start getting leads. You can add Facebook later."},
    "fb_optional_note": {"ru": "Можно пропустить — добавьте Facebook позже, когда будете готовы.", "he": "אפשר לדלג — הוסף פייסבוק מאוחר יותר כשתהיה מוכן.", "en": "Safe to skip — add Facebook later when you're ready."},
    ...
    "see_how_title": {"ru": "Посмотреть, как это работает", "he": "לראות איך זה עובד", "en": "See how it works"},
    "see_how_desc": {"ru": "Один клик → пример: реалистичный лид + AI-скоринг + 🔥 горячий лид. Увидишь поток до запуска.", "he": "לחיצה אחת → דוגמה: מועמד מציאותי + ניקוד AI + התראת ליד חם 🔥 — לראות את הזרימה לפני שמתחילים.", "en": "One click → a sample: realistic lead + AI score + a 🔥 hot-lead alert, so you can see the flow before going live."},
    "see_how_btn": {"ru": "Получить тестовый лид", "he": "קבל ליד חם לדוגמה", "en": "Get a sample hot lead"},
    "recent_activity": {"ru": "Последняя активность", "he": "פעילות אחרונה", "en": "Recent Activity"},
    "view_all": {"ru": "Все", "he": "הצג הכל", "en": "View All"},
    "safety_title": {"ru": "Как мы бережём ваш аккаунт", "he": "איך אנחנו שומרים על החשבון שלך", "en": "How we protect your account"},
    "safety_intro": {"ru": "Постинг во множество групп — серая зона для платформ. Мы делаем поведение максимально человеческим, чтобы снизить риск блокировки:", "he": "פרסום בקבוצות רבות הוא אזור אפור עבור הפלטפורמות. אנחנו גורמים להתנהגות להיראות אנושית ככל האפשר כדי להפחית סיכון חסימה:", "en": "Posting to many groups is a grey area for the platforms. We make the behaviour as human-like as possible to lower the risk of a block:"},
    "safety_human_typing": {"ru": "Текст набирается по символам со случайной задержкой (не вставка), как живой человек.", "he": "הטקסט מוקלד תו-אחר-תו בעיכוב אקראי (לא הדבקה), כמו אדם אמיתי.", "en": "Text is typed character-by-character with random delays (never pasted), like a real person."},
    "safety_pacing": {"ru": "Паузы между публикациями: Telegram — 30 сек–2 мин с разбросом ±30%, не больше 10 в час; Facebook — 5–10 мин между группами.", "he": "השהיות בין פרסומים: טלגרם — 30 שניות–2 דקות עם פיזור ±30%, עד 10 בשעה; פייסבוק — 5–10 דקות בין קבוצות.", "en": "Pauses between posts: Telegram — 30 s–2 min with ±30% jitter, max 10/hour; Facebook — 5–10 min between groups."},
    "safety_daily_cap": {"ru": "Дневной лимит — до 50 публикаций (настраивается в кампании).", "he": "מגבלה יומית — עד 50 פרסומים (ניתן להגדיר בקמפיין).", "en": "Daily cap — up to 50 posts (configurable per campaign)."},
    "safety_night": {"ru": "Ночью не постим — тишина с 23:00 до 07:00.", "he": "לא מפרסמים בלילה — שקט בין 23:00 ל-07:00.", "en": "No posting overnight — quiet from 23:00 to 07:00."},
    "safety_block_detect": {"ru": "Если платформа показывает блок/капчу — останавливаемся и ставим паузу на 30 минут.", "he": "אם הפלטפורמה מציגה חסימה/קאפצ'ה — עוצרים ומשהים ל-30 דקות.", "en": "If the platform shows a block/captcha — we stop and pause for 30 minutes."},
    "safety_recommend": {"ru": "Совет: используйте отдельный аккаунт для постинга и наращивайте активность постепенно в первые дни.", "he": "טיפ: השתמש בחשבון נפרד לפרסום והגדל את הפעילות בהדרגה בימים הראשונים.", "en": "Tip: use a separate account for posting and ramp up activity gradually in the first days."},
    "safety_honest": {"ru": "Это снижает риск блокировки, но не исключает его полностью. Вы используете сервис на свой риск.", "he": "זה מפחית את סיכון החסימה אך אינו מבטל אותו לחלוטין. השימוש על אחריותך.", "en": "This lowers the risk of a ban but cannot eliminate it. Use the service at your own discretion."},
    "roi_title": {"ru": "Ваши результаты", "he": "התוצאות שלך", "en": "Your results"},
    "roi_hours_unit": {"ru": "часов сэкономлено", "he": "שעות נחסכו", "en": "hours saved"},
    "roi_hours_caption": {"ru": "ручной работы заменено автоматикой", "he": "עבודה ידנית שהוחלפה באוטומציה", "en": "of manual work replaced by automation"},
    "roi_posts": {"ru": "Публикаций сделано", "he": "פרסומים שבוצעו", "en": "Posts published"},
    "roi_responses": {"ru": "Откликов получено", "he": "תגובות שהתקבלו", "en": "Responses captured"},
    "roi_hot_leads": {"ru": "Горячих лидов", "he": "לידים חמים", "en": "Hot leads"},
    "roi_estimate_note": {"ru": "Оценка: ~3 мин на ручную публикацию и ~5 мин на разбор отклика. Реальная экономия обычно выше.", "he": "הערכה: ~3 דקות לפרסום ידני ו~5 דקות לטיפול בתגובה. החיסכון בפועל בדרך כלל גבוה יותר.", "en": "Estimate: ~3 min per manual post and ~5 min per response triaged by hand. Real savings are usually higher."},
    "reg_title": {"ru": "Создать аккаунт", "he": "יצירת חשבון", "en": "Create account"},
    "reg_subtitle": {"ru": "Первые {days} дн. бесплатно. Карта не нужна.", "he": "{days} ימי ניסיון חינם. ללא כרטיס אשראי.", "en": "{days}-day free trial. No credit card required."},
    "reg_invite_label": {"ru": "Код приглашения", "he": "קוד הזמנה", "en": "Invite code"},
    "reg_invite_ph": {"ru": "Выдаётся при подключении", "he": "מתקבל בעת ההצטרפות", "en": "Provided when you're onboarded"},
    "reg_invite_note": {"ru": "Ранний доступ — по приглашению. Введите код, который вам выдали.", "he": "גישה מוקדמת — בהזמנה. הזינו את הקוד שקיבלתם.", "en": "Early access — by invitation. Enter the code you were given."},
    "reg_invite_bad": {"ru": "Неверный код приглашения.", "he": "קוד הזמנה שגוי.", "en": "Invalid invite code."},
    "reg_password": {"ru": "Пароль", "he": "סיסמה", "en": "Password"},
    "reg_password_hint": {"ru": "Минимум 6 символов", "he": "לפחות 6 תווים", "en": "Min 6 characters"},
    "reg_company": {"ru": "Название бизнеса", "he": "שם העסק", "en": "Company name"},
    "reg_company_ph": {"ru": "Название вашего бизнеса", "he": "שם העסק שלך", "en": "Your business name"},
    "reg_start_trial": {"ru": "Начать бесплатно", "he": "להתחיל ניסיון חינם", "en": "Start free trial"},
    "reg_have_account": {"ru": "Уже есть аккаунт?", "he": "כבר יש חשבון?", "en": "Already have an account?"},
    "reg_signin": {"ru": "Войти", "he": "כניסה", "en": "Sign in"},
    "worker_responses_title": {"ru": "Отклики", "he": "תגובות", "en": "Responses"},
    "worker_responses_sub": {"ru": "Последние лиды, прошедшие через AI-скрининг.", "he": "הלידים האחרונים שעברו סינון AI.", "en": "Latest leads flowing through AI screening."},
    "faq_q_screening": {"ru": "Как работает AI-скрининг?", "he": "איך עובד סינון ה-AI?", "en": "How does the AI screening work?"},
    "faq_a_screening": {"ru": "Люди откликаются на ваше объявление в Telegram. Бот задаёт 3–5 вопросов, оценивает ответы с помощью AI и присваивает балл. Вы видите только подходящие отклики.", "he": "אנשים מגיבים למודעה שלך בטלגרם. הבוט שואל 3–5 שאלות, מעריך את התשובות עם AI ונותן ניקוד. אתה רואה רק תגובות מתאימות.", "en": "People respond to your listing in Telegram. The bot asks 3–5 questions, scores the answers with AI, and ranks each one. You only see the responses worth your time."},
    "faq_q_langs": {"ru": "Какие языки поддерживаются?", "he": "אילו שפות נתמכות?", "en": "What languages are supported?"},
    "faq_a_langs": {"ru": "Русский, иврит и английский. Бот определяет язык собеседника автоматически по настройкам Telegram.", "he": "רוסית, עברית ואנגלית. הבוט מזהה את שפת הפונה אוטומטית לפי הגדרות הטלגרם שלו.", "en": "Russian, Hebrew, and English. The bot auto-detects each person's language from their Telegram settings."},
    "faq_q_trial": {"ru": "Можно попробовать бесплатно?", "he": "אפשר לנסות בחינם?", "en": "Can I try it for free?"},
    "faq_a_trial": {"ru": "Да! 2 недели бесплатно. Создайте объявление, опубликуйте в группу Telegram и смотрите, как приходят отклики.", "he": "כן! שבועיים ניסיון חינם. צור מודעה, פרסם לקבוצת טלגרם וצפה בתגובות נכנסות.", "en": "Yes! A free 2-week trial. Create one listing, post it to a Telegram group, and watch the responses come in."},
    "faq_q_tech": {"ru": "Нужны технические навыки?", "he": "צריך ידע טכני?", "en": "Do I need technical skills?"},
    "faq_a_tech": {"ru": "Нет. Всё управляется через веб-панель. Создайте объявление, напишите вопросы для скрининга — остальное сделает AI.", "he": "לא. הכול מנוהל דרך לוח בקרה באתר. צור מודעה, כתוב שאלות סינון — ה-AI עושה את השאר.", "en": "No. Everything runs from a web dashboard. Create a listing, write your screening questions, and the AI handles the rest."},
    "listing_core_title": {"ru": "Объявление", "he": "המודעה", "en": "Listing core"},
    "listing_context_title": {"ru": "Контекст объявления", "he": "הקשר המודעה", "en": "Listing context"},
    "fb_group_pick_intro": {"ru": "Выберите лучшие группы для этого объявления и создайте публикацию в один шаг.", "he": "בחר את הקבוצות הטובות ביותר למודעה הזו וצור פרסום בצעד אחד.", "en": "Pick the best groups for this listing, then create a posting run in one step."},
    ...
    "tg_phone_hint": {"ru": "Формат Telegram: +код страны и номер, только цифры. Например: +972551234567.", "he": "פורמט Telegram: +קידומת מדינה ומספר, ספרות בלבד. למשל: +972551234567.", "en": "Telegram format: +country code and number, digits only. Example: +972551234567."},
    "tg_phone_preview": {"ru": "Будет отправлено как", "he": "יישלח כך", "en": "Will be sent as"},
    "tg_phone_invalid_format": {"ru": "Номер должен начинаться с + и содержать 8-15 цифр.", "he": "המספר חייב להתחיל ב-+ ולהכיל 8-15 ספרות.", "en": "Phone must start with + and contain 8-15 digits."},
    "tg_country_israel": {"ru": "Израиль +972", "he": "ישראל +972", "en": "Israel +972"},
    "tg_country_usa": {"ru": "США +1", "he": "ארה\"ב +1", "en": "US +1"},
    "tg_country_ru": {"ru": "RU +7", "he": "RU +7", "en": "RU +7"},
    "tg_country_other": {"ru": "Другой +", "he": "אחר +", "en": "Other +"},
    "tg_open_api_tools": {"ru": "Открыть API tools", "he": "פתח API tools", "en": "Open API tools"},
    ...
    "tg_id_help": {"ru": "Не знаете свой ID? Напишите", "he": "לא יודע את ה-ID שלך? כתוב ל-", "en": "Don't know your ID? Message"},
    "hotlead_card_title": {"ru": "Оповещения о горячих лидах", "he": "התראות לידים חמים", "en": "Hot-lead alerts"},
    "hotlead_card_desc": {"ru": "Проверьте, что уведомления доходят: отправим вам в Telegram пример горячего лида прямо сейчас.", "he": "ודא שההתראות מגיעות: נשלח לך עכשיו דוגמה של ליד חם בטלגרם.", "en": "Check alerts reach you: we'll send a sample hot lead to your Telegram right now."},
    "send_test_hotlead_btn": {"ru": "Отправить тестовый лид мне в Telegram", "he": "שלח לי ליד לבדיקה בטלגרם", "en": "Send me a test hot lead"},
    "hotlead_need_id_hint": {"ru": "Сначала укажите Telegram ID выше и сохраните.", "he": "תחילה הזן Telegram ID למעלה ושמור.", "en": "First enter your Telegram ID above and save."},
    ...
    "photos_label": {"ru": "Фото объявления", "he": "תמונות המודעה", "en": "Listing photos"},
    "photos_drop": {
        "ru": "Перетащи фото сюда или нажми, чтобы выбрать",
        "he": "גרור תמונות לכאן או לחץ לבחירה",
        "en": "Drag photos here or click to choose",
    },
    "photos_for_posts": {
        "ru": "Эти фото пойдут в пост в Telegram и Facebook.",
        "he": "התמונות האלה ייכנסו לפוסט בטלגרם ובפייסבוק.",
        "en": "These photos go into your Telegram & Facebook post.",
    },
    "logo_label": {"ru": "Логотип компании", "he": "לוגו החברה", "en": "Company logo"},
    "logo_helper": {
        "ru": "PNG, JPG или WebP. Показывается в профиле и в брендировании постов.",
        "he": "PNG, JPG או WebP. מוצג בפרופיל ובמיתוג הפוסטים.",
        "en": "PNG, JPG or WebP. Shown on your profile and post branding.",
    },
    "logo_remove": {"ru": "Удалить логотип", "he": "הסר לוגו", "en": "Remove logo"},
    "nav_creatives": {"ru": "Креативы", "he": "קריאייטיב", "en": "Creatives"},
    "creatives_title": {"ru": "Креативы", "he": "ספריית קריאייטיב", "en": "Creatives"},
    "creatives_subtitle": {
        "ru": "Баннеры, постеры и логотипы для постов в Telegram и Facebook. Загрузи один раз — используй везде.",
        "he": "באנרים, פוסטרים ולוגואים לפוסטים בטלגרם ובפייסבוק. העלה פעם אחת — השתמש בכל מקום.",
        "en": "Banners, posters and logos for your Telegram & Facebook posts. Upload once, reuse everywhere.",
    },
    "creatives_upload_title": {"ru": "Загрузить креатив", "he": "העלאת קריאייטיב", "en": "Upload a creative"},
    "creatives_kind_label": {"ru": "Тип", "he": "סוג", "en": "Type"},
    "kind_banner": {"ru": "Баннер", "he": "באנר", "en": "Banner"},
    "kind_poster": {"ru": "Постер", "he": "פוסטר", "en": "Poster"},
    "kind_logo": {"ru": "Логотип", "he": "לוגו", "en": "Logo"},
    "kind_photo": {"ru": "Фото", "he": "תמונה", "en": "Photo"},
    "creatives_title_field": {"ru": "Название (необязательно)", "he": "כותרת (לא חובה)", "en": "Title (optional)"},
    "creatives_title_ph": {"ru": "Например: Осенняя акция", "he": "למשל: מבצע סתיו", "en": "e.g. Autumn promo"},
    "creatives_drop": {
        "ru": "Перетащи файл сюда или нажми, чтобы выбрать (PNG, JPG, WebP, GIF)",
        "he": "גרור קובץ לכאן או לחץ לבחירה (PNG, JPG, WebP, GIF)",
        "en": "Drag a file here or click to choose (PNG, JPG, WebP, GIF)",
    },
    "creatives_add_btn": {"ru": "Добавить в библиотеку", "he": "הוסף לספרייה", "en": "Add to library"},
    "creatives_empty": {"ru": "Пока пусто", "he": "עדיין ריק", "en": "Nothing here yet"},
    "creatives_empty_hint": {
        "ru": "Загрузи первый баннер или постер — он появится здесь и будет готов для постов.",
        "he": "העלה את הבאנר או הפוסטר הראשון — הוא יופיע כאן ויהיה מוכן לפוסטים.",
        "en": "Upload your first banner or poster — it shows up here, ready for your posts.",
    },
    "creatives_delete": {"ru": "Удалить", "he": "מחק", "en": "Delete"},
    "creatives_delete_confirm": {"ru": "Удалить этот креатив?", "he": "למחוק את הקריאייטיב הזה?", "en": "Delete this creative?"},
    "creatives_added": {"ru": "Креатив добавлен", "he": "הקריאייטיב נוסף", "en": "Creative added"},
    "creatives_deleted": {"ru": "Креатив удалён", "he": "הקריאייטיב נמחק", "en": "Creative deleted"},
    "creatives_err_nofile": {"ru": "Выбери файл для загрузки", "he": "בחר קובץ להעלאה", "en": "Choose a file to upload"},
    "creatives_err_badtype": {"ru": "Только PNG, JPG, WebP или GIF", "he": "רק PNG, JPG, WebP או GIF", "en": "Only PNG, JPG, WebP or GIF"},
    "photos_helper": {
