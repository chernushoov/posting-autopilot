...
UI = {
    ...
    # Vacancies
    "vacancies_title": {"ru": "Активная вакансия", "he": "משרה פעילה", "en": "Live vacancy"},
    "new_vacancy": {"ru": "+ Новая вакансия", "he": "+ משרה חדשה", "en": "+ New vacancy"},
    ...
    # Vacancy form
    "new_vacancy_title": {"ru": "Новая вакансия", "he": "משרה חדשה", "en": "New live vacancy"},
    ...
    "create_vacancy_btn": {"ru": "Создать вакансию", "he": "צור משרה", "en": "Create pilot-ready vacancy"},
    ...
    "vacancy": {"ru": "Вакансия", "he": "משרה", "en": "Vacancy"},
    ...
    # Candidates
    "candidates_title": {"ru": "Кандидаты", "he": "מועמדים", "en": "Candidates"},
    ...
    "total_candidates": {"ru": "Всего кандидатов", "he": "סה\"כ מועמדים", "en": "Total Candidates"},
    ...
    "job_vacancy": {"ru": "Вакансия", "he": "משרה", "en": "Job Vacancy"},
    ...
    "active_vacancies_count": {"ru": "активных вакансий", "he": "משרות פעילות", "en": "active vacancies"},
    ...
    # --- Candidate view ---
    "candidate_heading": {"ru": "Кандидат", "he": "מועמד", "en": "Candidate"},
    ...
    "vacancy_label": {"ru": "Вакансия", "he": "משרה", "en": "Vacancy"},
